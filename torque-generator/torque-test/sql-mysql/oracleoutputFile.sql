...
# -----------------------------------------------------------------------
drop table if exists TB_CMS_FLOW_DOC_TRANS;
...
# TD_CMS_CHANNELFIELD
# -----------------------------------------------------------------------
drop table if exists TD_CMS_CHANNELFIELD;
...
# TD_CMS_CHANNEL_VOTE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_CHANNEL_VOTE;
...
# TD_CMS_CHNL_REF_DOC
# -----------------------------------------------------------------------
drop table if exists TD_CMS_CHNL_REF_DOC;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_COLLECT_TIMECTRL2;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DBTSEARCH_DETAIL;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOCCOM_IMPEACHINFO;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_AGGREGATION;
...
# TD_CMS_DOC_ARRANGE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_ARRANGE;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_DIST_MANNER;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_PUBLISHING;
...
# TD_CMS_DOC_RELATED
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_RELATED;
...
# TD_CMS_DOC_TASK
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_TASK;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_TASK_DETAIL;
...
# TD_CMS_DOC_TEMPLATE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_TEMPLATE;

CREATE TABLE TD_CMS_DOC_TEMPLATE
(
    ID DECIMAL(10) NOT NULL,
    TPLNAME VARCHAR(50) NOT NULL,
    TPLCODE LONGTEXT NOT NULL,
    CHANNEL_ID DECIMAL(10) NOT NULL,
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_VER_ATTACH;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_EXTFIELDVALUE;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_EXTVALUESCOPE;
...
# TD_CMS_SITEAPPS
# -----------------------------------------------------------------------
drop table if exists TD_CMS_SITEAPPS;
...
# TD_CMS_SITEFIELD
# -----------------------------------------------------------------------
drop table if exists TD_CMS_SITEFIELD;
...
# TD_CMS_SITEUSER
# -----------------------------------------------------------------------
drop table if exists TD_CMS_SITEUSER;
...
# TD_CMS_SITE_TPL
# -----------------------------------------------------------------------
drop table if exists TD_CMS_SITE_TPL;
...
# TD_CMS_VOTE_ANSWER
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_ANSWER;
...
# TD_CMS_VOTE_IPCTRL
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_IPCTRL;
...
# TD_CMS_VOTE_ITEMS
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_ITEMS;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_TIMECTRL;
...
# TD_CMS_VOTE_TQ
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_TQ;
...
# TL_CMS_DOC_OPER_LOG
# -----------------------------------------------------------------------
drop table if exists TL_CMS_DOC_OPER_LOG;
...
# -----------------------------------------------------------------------
drop table if exists TL_CMS_SITE_FLOW_HIS;
...
# -----------------------------------------------------------------------
drop table if exists X_TD_CMS_PUBLISHSCHEDULAR;
...
# -----------------------------------------------------------------------
drop table if exists TB_CMS_DOC_STATUS_TRANS;
...
# TD_CMS_DOC_ATTACH
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_ATTACH;
...
# TD_CMS_DOC_VER
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_VER;
...
# TD_CMS_CHANNEL
# -----------------------------------------------------------------------
drop table if exists TD_CMS_CHANNEL;
...
# TD_CMS_DOCUMENT
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOCUMENT;
...
(
    ...
    GUIDANGTIME DATETIME,
    RECYCLETIME DATETIME,
...
# TD_CMS_DOC_COMMENT
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOC_COMMENT;
...
# TD_CMS_SITE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_SITE;
...
# TB_CMS_DOC_KIND
# -----------------------------------------------------------------------
drop table if exists TB_CMS_DOC_KIND;
...
# TB_CMS_DOC_LEVEL
# -----------------------------------------------------------------------
drop table if exists TB_CMS_DOC_LEVEL;
...
# TB_CMS_DOC_OPER
# -----------------------------------------------------------------------
drop table if exists TB_CMS_DOC_OPER;
...
# TB_CMS_DOC_STATUS
# -----------------------------------------------------------------------
drop table if exists TB_CMS_DOC_STATUS;
...
# TB_CMS_FLOW
# -----------------------------------------------------------------------
drop table if exists TB_CMS_FLOW;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_ADDWATERIMAGE;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_COLLECT_ANSWER;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_COLLECT_IPCTRL2;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_COLLECT_TITLE;
...
# TD_CMS_CUSTOM_FORM
# -----------------------------------------------------------------------
drop table if exists TD_CMS_CUSTOM_FORM;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOCCOMMENT_DICT;
...
# TD_CMS_DOCSOURCE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOCSOURCE;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_DOCUMENT_TEMP;
...
# TD_CMS_EXTFIELD
# -----------------------------------------------------------------------
drop table if exists TD_CMS_EXTFIELD;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_FILE_CHANGE_LOG;
...
# TD_CMS_FILE_STATUS
# -----------------------------------------------------------------------
drop table if exists TD_CMS_FILE_STATUS;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_MAILSERVERINFO;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_PUBOBJECT_RELATION;
...
# TD_CMS_SITE_SEARCH
# -----------------------------------------------------------------------
drop table if exists TD_CMS_SITE_SEARCH;
...
# TD_CMS_TEMPLATE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_TEMPLATE;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_TEMPLATE_STYLE;
...
# TD_CMS_TMPL_EXPORT
# -----------------------------------------------------------------------
drop table if exists TD_CMS_TMPL_EXPORT;
...
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_QUESTIONS;
...
# TD_CMS_VOTE_TITLE
# -----------------------------------------------------------------------
drop table if exists TD_CMS_VOTE_TITLE;
...
# TEST_DICT1
# -----------------------------------------------------------------------
drop table if exists TEST_DICT1;
...
# V_DOC_FLOW_TRANS
# -----------------------------------------------------------------------
drop table if exists V_DOC_FLOW_TRANS;
...
# V_TB_RES_ORG_ROLE
# -----------------------------------------------------------------------
drop table if exists V_TB_RES_ORG_ROLE;
...
# V_TB_RES_ORG_USER
# -----------------------------------------------------------------------
drop table if exists V_TB_RES_ORG_USER;
...
# V_TB_RES_ROLE_ROLE
# -----------------------------------------------------------------------
drop table if exists V_TB_RES_ROLE_ROLE;
...
# V_TB_RES_ROLE_USER
# -----------------------------------------------------------------------
drop table if exists V_TB_RES_ROLE_USER;
...
# V_TB_USER_ALLROLE
# -----------------------------------------------------------------------
drop table if exists V_TB_USER_ALLROLE;
...
# V_TD_CMS_DOCUMENT
# -----------------------------------------------------------------------
drop table if exists V_TD_CMS_DOCUMENT;
...
# -----------------------------------------------------------------------
drop table if exists V_TD_SM_USER_ALLROLE;
...
# -----------------------------------------------------------------------
drop table if exists V_USER_ONE_ORG_ONE_JOB;
...
# V_USER_ORG
# -----------------------------------------------------------------------
drop table if exists V_USER_ORG;
