...
public class Launcher
{
    ...
    public static void run(String[] args) throws MalformedURLException, SecurityException, IllegalArgumentException,
...
//        Object instance = mainClass.newInstance();
        ...
        method.invoke(null, new Object[] {new String[]{String.valueOf(ispatch)}});
   ...
   static boolean ispatch= false;
    public static void main(String[] args) throws MalformedURLException, SecurityException, IllegalArgumentException,
            ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, FileNotFoundException, InstantiationException
    {
