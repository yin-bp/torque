 ...
 * @version $Id: TestPackageHandling.java 692847 2008-09-07 13:37:40Z tfischer $
 */
public class TestPackageHandling extends TestCase
{
            ...
            throws Exception
    {
        ...
        database = xmlToAppData.parseFile(
            "src/test/java/org/apache/torque/engine/database/package-schema.xml");
            ...
            throws Exception
    {
        xmlToAppData = new XmlToAppData("mysql", "defaultpackage");
        database = xmlToAppData.parseFile(
            "src/test/java/org/apache/torque/engine/database/package2-schema.xml");
