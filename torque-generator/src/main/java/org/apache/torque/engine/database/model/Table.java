 ...
 * @version $Id: Table.java 473814 2006-11-11 22:30:30Z tv $
 */
public class Table implements IDMethod
{
    ...
    private List<ForeignKey> referrers;
    ...
    public void addReferrer(ForeignKey fk)
    {
        if (referrers == null)
        {
            referrers = new ArrayList<ForeignKey>(5);
        }
        referrers.add(fk);
    }
	...
	public Database getTableParent() {
		return tableParent;
	}
}
